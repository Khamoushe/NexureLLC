        ...
        <main className="min-h-screen bg-[#050a0e] text-white">
            ...
            <div className="pt-32 pb-20 px-6 max-w-4xl mx-auto">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-6xl font-bold mb-6">THE <span className="text-zoo-secondary">ZOOKEEPERS</span></h1>
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-20">
                    <div className="glass-panel p-8 rounded-2xl text-center hover:border-zoo-primary/50 transition-colors">
                    ...
                    <div className="glass-panel p-8 rounded-2xl text-center hover:border-zoo-secondary/50 transition-colors">
                    ...
                    <div className="glass-panel p-8 rounded-2xl text-center hover:border-zoo-accent/50 transition-colors">
